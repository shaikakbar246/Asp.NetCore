...
//    {
//        /// <summary>
//        /// An Extension method to convert an
//        /// object of person class into 
//        /// PersonResponse class
//        /// </summary>
//        /// <param name="person">Returns 
//        /// The converted PersonResponse object</param>
    ...
    public static class PersonExtensions
    {
        ...
        public static PersonResponse ToPersonResponse(this Person person)
        {
            ...
            return new PersonResponse()
            {
                ...
                Country=person.Countries?.CountryName
            };
        }
